...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-body">
        ...
        <div style="padding: 15px;">
            <button class="layui-btn layui-bg-orange">迟到人员<span id="out" class="layui-badge layui-bg-gray">1</span></button>
            <button class="layui-btn layui-bg-orange">异常进出<span class="layui-badge layui-bg-gray">1</span></button>
